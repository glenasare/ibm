  ...
  return (
    <div style={{ height: "100vh" }}>
      <ImageContainer>
        ...
        <ImageText> <h1>We Honor One Another to Glorify God</h1></ImageText>
      </ImageContainer>
      ...
      <MainAboutContainter>
        ...
        <MainAboutText>
            <HeaderText>Welcome To </HeaderText><HeaderText2>International Baptist Ministries</HeaderText2>
